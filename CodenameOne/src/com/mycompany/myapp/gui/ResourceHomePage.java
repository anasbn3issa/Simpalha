...
public class ResourceHomePage extends SideMenu  {
    ...
    public ResourceHomePage(Resources res)  {
                setupSideMenu(res);
                ArrayList<Ressources> list;
                list = new ArrayList<Ressources>();
       
                list = RessourceService.getInstance().getListRessource();        
                setTitle("Simpalha's RESOURCES ");
                
                
                Button sort = new Button("Sort by module");
                sort.addActionListener(
                        
                        e->{

                    new ResourceHomePageSorted(res).show();
                        }
