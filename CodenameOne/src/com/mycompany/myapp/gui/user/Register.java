...
public class Register extends Form {
   ...
   ser.SingUp(firstName.getText(),lastName.getText(),date.getDate(),Integer.parseInt(phone.getText()),address.getText(),pseudo.getText(),password.getText(),email.getText());
