 ...
 * @author bhk
 */
public class ListHelperMeetsForm extends Form {

    public ListHelperMeetsForm(Resources res) {
        setLayout(new BorderLayout(BorderLayout.CENTER_BEHAVIOR_CENTER));
        setScrollableY(true);
        setScrollableX(true);
        setScrollVisible(false);

        ArrayList<Meet> meets = MeetService.getInstance().getAllHelperMeets();
        ...
        if (!meets.isEmpty()) {
            ...
            Label lbhelpers = new Label("Student");
