...
public class AddDispoForm extends SideMenu {

    public AddDispoForm(Resources res) {
        setTitle("New Disponibilie");
        setupSideMenu(res);
        ...
        confirmButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                try {
                    ...
                    Disponibilite dis = new Disponibilite();
                    dis.setDatedeb(simpleDateFormat.format(datestart));
                    dis.setDateFin(simpleDateFormat.format(datefinish));
                    System.out.println(dis.getDatedeb());
                    System.out.println(dis.getDateFin());
                    dis.setHelperid(Session.ConnectedUser.getId());
                    if (DispoService.getInstance().addDispo(dis)) {
